# FOR-BBG-
: A digital birthday surprise for the most special person.
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        ...
        .reveal-btn:hover { background: #ff4d94; transform: translateY(-3px); box-shadow: 0 8px 20px rgba(214, 51, 132, 0.4); }
...
<div class="container">
    <div id="pre-text" style="color: #a3a3a3; margin-bottom: 25px; font-weight: 300; letter-spacing: 1px;">Something special for you...</div>
...
<script>
    function celebrate() {
        ...
        // Launch beautiful confetti cannons
